...
<nav class="navbar navbar-expand-lg navbar-custom">
    ...
    <div class="container mt-4">
        ...
        <div class="row button-section">
            <div class="col-md-6">
                <button class="btn btn-primary" onclick="createExamPanel()"><class style="color: white;">Create Exam Panel</a></button>
                <button class="btn btn-primary" onclick="createBill()"><class style="color: white;">Create Bill</a></button>
                <button class="btn btn-primary" onclick="trackBill()"><class style="color: white;" >Track Bill</a></button>
                <button class="btn btn-primary" onclick="billHistory()"><class style="color: white;">Bill History</a></button>
            </div>
    ...
    function createExamPanel() {
        // Redirect to createExamPanel.php
        window.location.href = 'createExamPanel.php';
    }

    function createBill() {
            window.location.href = 'createbill.php';
        }
function billHistory() {
            window.location.href = 'billhistory.php';
        }
function trackBill() {
            window.location.href = 'trackbill.php';
        }
    </script>
