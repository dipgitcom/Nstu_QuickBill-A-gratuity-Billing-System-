...
<nav class="navbar navbar-expand-lg navbar-custom">
    ...
    <div class="center-content">
        <div class="button-section">
            <button class="btn btn-primary" onclick="createExamCommittee()">Create Exam Committee</button>
        </div>
        <div class="button-section">
            <button class="btn btn-primary" onclick="showExamCommittee()">All Committees</button>
        </div>
    </div>
    ...
    <script>
        function createExamCommittee() {
            window.location.href = 'xmCommittee.php';  // Redirect to the xmCommittee.php page
        }
        function showExamCommittee(){
            window.location.href = 'allCommittees.php';  // Redirect to the allCommittees.php page
        }
    </script>
</body>
